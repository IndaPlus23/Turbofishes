...
1) Install [SWI-Prolog](https://www.swi-prolog.org/). _As a \[Windows user\], you are entitled to the SWI-prolog-command-prompt profile to add to your Windows Terminal settings. You're welcome._
```json
{
    "acrylicOpacity": 0.75,
    "closeOnExit": true,
